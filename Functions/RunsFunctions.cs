...
/// <summary>Run sub-resources that are plain DB reads (NOT blob artifacts — those moved to ArtifactsFunctions).</summary>
public class RunsFunctions
{
    private readonly SynthWatchDbContext _db;

    public RunsFunctions(SynthWatchDbContext db)
    {
        _db = db;
    }
